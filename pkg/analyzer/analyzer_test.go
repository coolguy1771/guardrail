...
func (m *mockRBACReader) Roles(namespace string) rbacv1client.RoleInterface {
	return &mockRoleInterface{roles: m.roles, err: m.err}
}

func (m *mockRBACReader) RoleBindings(namespace string) rbacv1client.RoleBindingInterface {
	return &mockRoleBindingInterface{roleBindings: m.roleBindings, err: m.err}
}

func (m *mockRBACReader) ClusterRoles() rbacv1client.ClusterRoleInterface {
	return &mockClusterRoleInterface{clusterRoles: m.clusterRoles, err: m.err}
}

func (m *mockRBACReader) ClusterRoleBindings() rbacv1client.ClusterRoleBindingInterface {
	return &mockClusterRoleBindingInterface{clusterRoleBindings: m.clusterRoleBindings, err: m.err}
}
...
func (m *mockRoleInterface) List(ctx context.Context, opts metav1.ListOptions) (*rbacv1.RoleList, error) {
	if m.err != nil {
		return nil, m.err
	}
...
func (m *mockRoleBindingInterface) List(ctx context.Context, opts metav1.ListOptions) (*rbacv1.RoleBindingList, error) {
	if m.err != nil {
		return nil, m.err
	}
...
func (m *mockClusterRoleInterface) List(ctx context.Context, opts metav1.ListOptions) (*rbacv1.ClusterRoleList, error) {
	if m.err != nil {
		return nil, m.err
	}
...
func (m *mockClusterRoleBindingInterface) List(ctx context.Context, opts metav1.ListOptions) (*rbacv1.ClusterRoleBindingList, error) {
	if m.err != nil {
		return nil, m.err
	}
...
func TestNewAnalyzer(t *testing.T) {
	...
	if analyzer.objects != nil && len(analyzer.objects) == 0 {
		// Empty slice is acceptable - it's initialized but empty
	} else if analyzer.objects != nil {
